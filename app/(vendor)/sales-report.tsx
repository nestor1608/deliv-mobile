...
export default function SalesReportScreen() {
    ...
    const renderRevenueChart = () => (
        <View style={styles.chartContainer}>
            ...
            <LineChart
                data={{
                    labels: ['Lun', 'Mar', 'Mié', 'Jue', 'Vie', 'Sáb', 'Dom'],
                    datasets: [{ data: [2000, 3200, 2800, 4100, 3900, 5200, 4800] }],
                }}
                title="Ingresos"
                lineColor="#4CAF50"
            />
    ...
    const renderOrdersChart = () => (
        <View style={styles.chartContainer}>
            ...
            <BarChart
                data={{
                    labels: ['Lun', 'Mar', 'Mié', 'Jue', 'Vie', 'Sáb', 'Dom'],
                    datasets: [{ data: [12, 19, 15, 24, 22, 28, 26] }],
                }}
                title="Pedidos"
                barColor="#2196F3"
            />
    ...
    const renderCategoryChart = () => (
        <View style={styles.chartContainer}>
            ...
            <PieChart
                data={[
                    { name: 'Platos principales', population: 45, color: '#FF6B6B' },
                    { name: 'Bebidas', population: 25, color: '#4ECDC4' },
                    { name: 'Postres', population: 15, color: '#45B7D1' },
                    { name: 'Entradas', population: 10, color: '#96CEB4' },
                    { name: 'Otros', population: 5, color: '#FFEAA7' },
                ]}
