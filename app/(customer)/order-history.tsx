...
export default function OrderHistoryScreen() {
    ...
    const prevMockOrdersRef = useRef(mockOrders);
    useEffect(() => {
        if (mockOrders && mockOrders !== prevMockOrdersRef.current) {
            filterOrders(mockOrders);
            prevMockOrdersRef.current = mockOrders;
        }
    }, [mockOrders]);
    ...
    const handleReorder = (order) => {
        router.push({
            ...
            params: { storeId: order.store_id, storeName: order.store_name, reorderItems: JSON.stringify(order.items) }
        });
    };
