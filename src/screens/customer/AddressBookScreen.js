// src/screens/customer/AddressBookScreen.js
...
const AddressBookScreen = ({ navigation }) => {
        ...
        try {
            ...
            const mockAddresses = [
                ...
                },
                {
                    ...
                    reference: 'Al lado del café de la esquina',
                    coordinates: {
                        latitude: -34.5875,
                        longitude: -58.4170,
                    },
    ...
    const handleSetDefault = async (address) => {
        try {
            ...
            Alert.alert('Error', 'No se pudo actualizar la dirección por defecto');
        }
    };
    ...
    const handleSaveAddress = async () => {
        ...
        try {
            const addressData = {
                ...
                type: 'other', // Puedes agregar un selector de tipo si quieres
            };
            ...
            if (editingAddress) {
                ...
                const newAddress = {
                    id: Date.now(), // En producción usarías el ID del servidor
                    ...addressData,
