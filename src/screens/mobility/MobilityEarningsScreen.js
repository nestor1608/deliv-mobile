// src/screens/mobility/MobilityEarningsScreen.js
...
export default function MobilityEarningsScreen() {
  ...
  const loadEarnings = async () => {
    setLoading(true);
    try {
      const response = await authenticatedFetch(`/api/mobility/drivers/earnings/?period=${selectedPeriod}`);
      if (response.ok) {
        ...
        const mockData = {
          today: {
            ...
            daily: [
              { date: '2024-01-15', total: 125.75, trips: 8 },
            ]
          },
          week: {
            summary: {
            ...
            daily: [
              { date: '2024-01-15', total: 125.75, trips: 8 },
              { date: '2024-01-14', total: 142.50, trips: 9 },
              { date: '2024-01-13', total: 98.25, trips: 6 },
              { date: '2024-01-12', total: 156.00, trips: 10 },
              { date: '2024-01-11', total: 89.50, trips: 5 },
              { date: '2024-01-10', total: 68.50, trips: 4 },
            ]
          },
          month: {
            summary: {
  ...
  const renderDailyEarning = (day, index) => (
    <View key={index} style={styles.dailyItem}>
      ...
      <View style={styles.dailyStats}>
        <Text style={styles.dailyTrips}>{day.trips} viajes</Text>
      ...
      >
        ...
        <View style={styles.mainSummary}>
          ...
          <View style={styles.mainStats}>
            <View style={styles.mainStat}>
              <Text style={styles.mainStatValue}>{earnings.trips}</Text>
              <Text style={styles.mainStatLabel}>Viajes</Text>
            </View>
            <View style={styles.mainStat}>
              <Text style={styles.mainStatValue}>${earnings.averagePerTrip}</Text>
              <Text style={styles.mainStatLabel}>Promedio</Text>
            </View>
            <View style={styles.mainStat}>
              <Text style={styles.mainStatValue}>{earnings.onlineHours}h</Text>
              <Text style={styles.mainStatLabel}>En línea</Text>
            </View>
            <View style={styles.mainStat}>
              <Text style={styles.mainStatValue}>{earnings.ratings} ★</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.statsGrid}>
            ...
            {renderStatsCard(
              'Por hora',
              `$${(earnings.total / earnings.onlineHours || 0).toFixed(2)}`,
              'schedule',
              '#4CAF50',
              'Ganancia promedio'
            )}
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Comparación de rendimiento</Text>
          
          <View style={styles.comparisonContainer}>
            <View style={styles.comparisonItem}>
              <Icon name="trending-up" size={24} color="#4CAF50" />
              <View style={styles.comparisonText}>
                <Text style={styles.comparisonTitle}>Mejora vs. período anterior</Text>
                <Text style={styles.comparisonValue}>+12.5% en ganancias</Text>
              </View>
            </View>
            ...
            <View style={styles.comparisonItem}>
              ...
              <View style={styles.comparisonText}>
                <Text style={styles.comparisonTitle}>Tiempo de respuesta</Text>
                <Text style={styles.comparisonValue}>2.3 min promedio</Text>
              </View>
            </View>
            ...
            <View style={styles.comparisonItem}>
              ...
              <View style={styles.comparisonText}>
                <Text style={styles.comparisonTitle}>Tasa de cancelación</Text>
                <Text style={styles.comparisonValue}>3.2% (Excelente)</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Consejos para maximizar ganancias</Text>
          
          <View style={styles.tipsContainer}>
            <View style={styles.tipItem}>
              <Icon name="access-time" size={20} color="#FF9800" />
              <Text style={styles.tipText}>
                Trabaja en horarios pico: 7-9h, 12-14h y 18-22h
              </Text>
            </View>
            ...
            <View style={styles.tipItem}>
              ...
              <Text style={styles.tipText}>
                Mantente en zonas de alta demanda como centros comerciales y aeropuertos
              </Text>
            </View>
            ...
            <View style={styles.tipItem}>
              ...
              <Text style={styles.tipText}>
                Mantén un rating alto (4.7+) para recibir más solicitudes
              </Text>
            </View>
            ...
            <View style={styles.tipItem}>
              ...
              <Text style={styles.tipText}>
                Acepta viajes rápidamente para mejorar tu puntuación
              </Text>
            </View>
          </View>
        </View>
